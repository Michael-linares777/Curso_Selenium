...
mail = driver.find_element(By.XPATH,"//input[@id='userEmail' and @type='email']")
mail.send_keys("Linaresvelascomichael@gmail.com")
time.sleep(1)

direccion = driver.find_element(By.XPATH,"//textarea[contains(@id,'currentAddress') and @placeholder='Current Address']")
...
boton = driver.find_element(By.XPATH,"//button[contains(@id,'submit') and @type='button']")
boton.click()
time.sleep(2)
